  ...
  loadFbLoginApi() {
    ...
    window.fbAsyncInit = function() {
      ...
      (function(d, s, id){
         ...
         js.src = "https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v7.0&appId=532621444084960";
    ...
    fieldsApi = (authResponse) => {
        ...
        window.FB.api('/me?fields=name,email,age_range', function(response) {
            ...
            facebookAuth({
                ...
                facebook_data_access_expiration_time: authResponse.data_access_expiration_time,
    ...
    handleFBLogin = () => {
        window.FB.login(this.checkLoginState, { scope: 'email,user_age_range', return_scopes: true});
    }
    ...
    render() {
        return (
                <div>
                    <FacebookLoginButton 
                        align="center"
                        style={{fontSize: '14px', width: '300px', height: '40px', textAlign: 'center'}} 
