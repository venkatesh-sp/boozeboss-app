...
import { GET_ITEMS_REQUEST, ORDER_ITEMS_REQUEST } from './constants';

import { getCartItemsSuccess, getCartItemsError, postOrder } from './actions';
...
export default function* rootSaga() {
  yield all([, fork(getCartItemsRequest), fork(postOrdersRequest)]);
}
