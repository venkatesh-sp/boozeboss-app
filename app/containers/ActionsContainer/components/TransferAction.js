      ...
      return (
        <div>
          ...
          >
            ...
            <TransferRow> 
              {action.action === 'SENT_TRANSFER' && <span>Sent <b>{action.amount}</b><Icon icon="circle" style={{color: '#c2b90a', margin: '0 0.5em 0 0.5em'}}/> to <b>{action.target_account.email}</b></span>}
              {action.action === 'RECEIVED_TRANSFER' && <span>Received <b>{action.amount}</b><Icon icon="circle" style={{color: '#c2b90a', margin: '0 0.5em 0 0.5em'}}/> from <b>{action.source_account.email}</b></span>}
            </TransferRow>
          </TransferCard>
