      ...
      >
        {isAuthenticated && (
          <React.Fragment>
            ...
            {user &&
              !user.age_verification_status &&
              user.facebook_user_id &&
              new Date(user.temporal_age_verification_limit).getTime() >=
                new Date().getTime() && (
                <MessageContainer>
                  <Message
                    description={
                      <div>
                        <p>
                          <b>Facebook</b> login has a 48 hour temporal
                          verification limit. Please verify your account by{' '}
                          {moment(user.temporal_age_verification_limit).format(
                            'DD/MM/YYYY LT',
                          )}{' '}
                          to keep full access.
                        </p>
              ...
              <MessageContainer>
                <Message
                  ...
                  description={
                    <div>
                      <p>
                        Please verify your age to have complete access to
                        BoozeBoss wallet.
                      </p>
                    </div>
                  }
